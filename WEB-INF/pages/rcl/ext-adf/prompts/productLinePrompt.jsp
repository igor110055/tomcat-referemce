...
<%--
   ...
   $Id: productLinePrompt.jsp 8614 2013-11-06 21:15:18Z dk $
...
<head>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/rcl/ext-adf/gosl/prompts/ProductLinePromptUi.js"></script>
</head>
