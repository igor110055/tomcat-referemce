...
<head>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/rcl/ext-adf/prompts/GeneratedPrompts.js"></script>
   <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/rcl/ext-adf/prompts/dynamicGeneratedPromptUi.js"></script>
...
<body class="rclBody customPromptIframeBody"
   ...
   <html:form action="/secure/actions/ext/xmlGeneratedPrompt">
