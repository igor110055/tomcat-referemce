...
<%--
   ...
   $Id: geographicHierarchyPrompt.jsp 8386 2013-05-24 15:45:32Z jsiler $
...
<head>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/rcl/gosl/prompts/GeographicHierarchyPromptUi.js"></script>
