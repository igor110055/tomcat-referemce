...
<%--
   ...
   $Id: migratedProductHierarchyPrompt.jsp 9255 2015-07-07 23:34:09Z sallman $
...
<head>
   ...
   <%-- Migration: include the widgets. --%>
   <%@ include file="/WEB-INF/pages/common/commonPromptIncludes.jsp"%>

   <%-- Migration: comment out the old legacy widgets. --%>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/rcl/gosl/prompts/MigratedProductHierarchyPromptUi.js"></script>
