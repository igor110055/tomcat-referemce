...
<head>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/rcl/gosl/prompts/MigratedProductHierarchyPromptDivListUi.js"></script>
