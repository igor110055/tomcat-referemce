...
<%--
   ...
   $Id: salesRepPrompt.jsp 8386 2013-05-24 15:45:32Z jsiler $
...
<head>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/rcl/gosl/prompts/SalesRepPromptUi.js"></script>
...
<body class="rclBody customPromptIframeBody"
   ...
   <html:form action="/secure/actions/salesRepPrompt">
      ...
      <div class="screenTitle"><fmt:message key="prompt.salesRep.subTitle"/></div>
      <br/>
      <div>
