...
<%--
   displays details about a report profile or softlink...


   ---------------------------
   @author : Lance Hankins (lhankins@focus-technologies.com)

   $Id: reportProfileDetails.jsp 6558 2009-02-13 19:44:23Z dsellari $
            ...
            <rcl:panel styleId="generalPanel" titleKey="propertiesPanel.title.general">
               ...
               <div class="scrollDiv">
                  <table class="properties">
                     ...
                     <c:if test="${contentNode.reportProfile}">
                        <tr>
                     ...
                     <c:if test="${contentNode.softLink}">
                        <tr>
                           <td class="propertyLabel">
                              <fmt:message key="propertiesPanel.label.softLinkName"/>
                           </td>
                           <td class="propertyValue">
                              <c:out value="${contentNodeDetailsForm.contentNodeName}"/>
                           </td>
                        ...
                        <tr>
                           <td class="propertyLabel">
                              <fmt:message key="propertiesPanel.label.targetReportProfile"/>
                           </td>
                           <td class="propertyValue">
                              <c:out value="${contentNodeDetailsForm.targetProfileSimplePath}"/>
                           </td>
                        </tr>
                     </c:if>
                     ...
                     <tr>
                        <td class="propertyLabel">
                           <fmt:message key="propertiesPanel.label.targetReportPath"/>
                        </td>
                        <td class="propertyValue">
                           <c:out value="${contentNodeDetailsForm.targetReportSimplePath}"/>
                        </td>
                     </tr>
                     <tr>
                        <td class="propertyLabel">
                     ...
                     <tr>
                        ...
                        <td>
                           <c:if test="${contentNodeDetailsForm.recentRerId != null}">
                              <div class="property">
                                 <div class="propertLabel">
                                    <a href="javascript:launchReportViewer([<c:out value="${contentNodeDetailsForm.recentRerId}"/>])">View Recent Output</a>
                                 </div>
                              </div>
                           </c:if>
                        </td>
