...
<%--
   ...
   $Id: browseSchedules.jsp 7324 2011-02-02 20:31:32Z jjames $
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
   <head>
      ...
      <title><fmt:message key="browseSchedules.title"/></title>
      ...
      <style type="text/css">
         ...
         @import "<%= request.getContextPath() %>/styles/rcl/browseSchedules.css";

         /*
         IMPORTANT : if you modify the width of these, update #scheduleGrid definition in
         browseSchedules.css (firefox) & browserHacks.css for IE6/IE7
         */
         div.grid *.column-0 {width: 40px; text-align: right;}
         div.grid *.column-1 {width: 340px; background-color: ThreeDLightShadow;}
         div.grid *.column-2 {width: 75px; text-align: left;}
         div.grid *.column-3 {width: 150px; text-align: right;}
         div.grid *.column-4 {width: 150px; text-align: right;}
         div.grid *.column-5 {width: 87px; text-align: right;}
      ...
      <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/rcl/scheduler/BrowseSchedulesUi.js"></script>
      ...
      <script type="text/javascript">
         ...
         <c:out value="${browseSchedulesForm.jsScheduleStatusEnums}" escapeXml="false" />

         <%-- this getter defines and populates a JS array of Rer Summaries called scheduleSummaries--%>
         <c:out value="${browseSchedulesForm.jsScheduleSummaries}" escapeXml="false" />

         var uiModel = new BrowseSchedulesUiModel (scheduleSummaries, scheduleStatusStrings);
         var uiController = new BrowseSchedulesUiController(document, uiModel);
   ...
   <body class="rclBody workspace"
      ...
      <div id="bodyDiv">
         <div id="contentShell">
            ...
            <html:form action="/secure/actions/browseSchedules.do" method="get">
               ...
               <div id="workspace">
                  ...
                  <div id="nextPrevButtons">
                     ...
                     / <c:out value="${form.pagedScheduleSummaries.pagingInfo.totalPages}"/>
                     </label>
                  ...
                  <div id="workspaceBody" class="workspaceBodyNormal">
                     <div id="scheduleGrid" onselectstart="return false;" >
                     </div>
