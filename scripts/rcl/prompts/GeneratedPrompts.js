...
// $Id: GeneratedPrompts.js 7207 2010-07-21 19:55:54Z jjames $



/**
 * ParameterInfo - info about a single parameter
 * @class
 * @constructor
...
AbstractGeneratedPrompt.prototype.getDomId = function()
{
   return "dgp_" + this.paramInfo.name;
}

AbstractGeneratedPrompt.prototype.createNewParameter = function()
{
...
AbstractGeneratedPrompt.prototype.getPromptContainerDiv = function()
{
...
HierarchicalJsListBox.prototype = new JsListBox();
HierarchicalJsListBox.prototype.constructor = HierarchicalJsListBox;
HierarchicalJsListBox.superclass = JsListBox.prototype;

HierarchicalJsListBox.prototype.propagateSelectionChanges = function()
{
...
HierarchicalJsListBox.prototype.selectAll = function()
{
   HierarchicalJsListBox.superclass.selectAll.call(this);
   this.propagateSelectionChanges();
};

HierarchicalJsListBox.prototype.refreshView = function(aContainer)
{
...
HierarchicalJsListBox.prototype.propagateContainer = function( aContainer )
{
  if (JsUtil.isGood(this.childListBox))
  {
     this.childListBox.container = aContainer;
     this.childListBox.propagateContainer( aContainer );
  }
}

HierarchicalJsListBox.prototype.initialize = function()
{
   var param

   if (JsUtil.isGood(this.container))
   {
      param = this.container.prompts[this.name];
   }
   else
   {
