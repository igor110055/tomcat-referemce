...
<head>
   ...
   <style type="text/css">
      .wizard-icon-operator { background-image: url('<%=request.getContextPath()%>/images/md/operator.gif') !important; }
      .wizard-icon-summary { background-image: url('<%=request.getContextPath()%>/images/md/summary.gif') !important; }
      .wizard-icon-literal { background-image: url('<%=request.getContextPath()%>/images/md/literal.gif') !important; }
      .wizard-icon-function { background-image: url('<%=request.getContextPath()%>/images/md/function.gif') !important; }
   </style>

   <!-- Include here you application javascript file if you have it. -->
   <script type="text/javascript" src="<%=request.getContextPath()%>/scripts/rcl/test/wizardFunctionTreeUi.js"></script>

   <!-- Set a title for the page (id is not necessary). -->
   <title id="page-title">Wizard Function Tree</title>
